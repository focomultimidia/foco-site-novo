...
export { DoresDiagnosticoSection } from "./dores-diagnostico-section";
export { OtheoAiTeaserSection } from "./otheo-ai-teaser-section";
export { ParceirosEliteSection } from "./parceiros-elite-section";
