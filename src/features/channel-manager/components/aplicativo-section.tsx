...
const PHONE_SLIDES = [
  { src: "/assets/imgs/channel-manager/aplicativo-hotel/calendario.webp",       alt: "Channel Manager: Calendário" },
  { src: "/assets/imgs/channel-manager/aplicativo-hotel/mapa.webp",             alt: "Channel Manager: Mapa de reservas" },
  { src: "/assets/imgs/channel-manager/aplicativo-hotel/multiplus-envios.webp", alt: "Channel Manager: Múltiplos envios" },
  { src: "/assets/imgs/channel-manager/aplicativo-hotel/dashboard.webp",        alt: "Channel Manager: Dashboard" },
] as const;
