...
const SLIDES = [
  { desktopImage: "/assets/imgs/gestao-hoteleira-pms/1.png", mobileImage: "/assets/imgs/gestao-hoteleira-pms/site1.png", label: "Busca de disponibilidade",  alt: "Busca de disponibilidade" },
  { desktopImage: "/assets/imgs/gestao-hoteleira-pms/2.png", mobileImage: "/assets/imgs/gestao-hoteleira-pms/site2.png", label: "Seleção de quarto",         alt: "Seleção de quarto" },
  { desktopImage: "/assets/imgs/gestao-hoteleira-pms/3.png", mobileImage: "/assets/imgs/gestao-hoteleira-pms/site3.png", label: "Checkout seguro",           alt: "Checkout seguro" },
  { desktopImage: "/assets/imgs/gestao-hoteleira-pms/4.png", mobileImage: "/assets/imgs/gestao-hoteleira-pms/site4.png", label: "Confirmação instantânea",   alt: "Confirmação instantânea" },
  { desktopImage: "/assets/imgs/gestao-hoteleira-pms/5.png", mobileImage: "/assets/imgs/gestao-hoteleira-pms/site1.png", label: "Painel do hoteleiro",       alt: "Painel do hoteleiro" },
];
