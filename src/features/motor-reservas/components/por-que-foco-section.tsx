          ...
          {beneficios.map((beneficio, index) => {
            ...
            return (
              <motion.div
                ...
                className="flex items-start gap-4 bg-white rounded-xl p-6 border border-gray-100 hover:shadow-lg transition-shadow duration-300"
              >
